    ...
    public boolean onMenuItemClick(MenuItem item) {
        switch (item.getItemId()){
            case R.id.DCJG_yinglian_detail:
                YinglianShowActivity.actionstart(JinGeSiActivity.this,name,"大藏经阁");
                break;
            case R.id.DCJG_voice_desc:
                startActivity(new Intent(JinGeSiActivity.this, DaCangJingGeActivity.class));
                break;
            case R.id.DCJG_content:
                Jianjie_dadian_actiivty.actionstart1(JinGeSiActivity.this,name,"藏经阁");
                break;
            case R.id.DBT_yinglian_detail:
                YinglianShowActivity  .actionstart(JinGeSiActivity.this,name,"大白塔");
                break;
            case R.id.DBT_voice_desc:
                startActivity(new Intent(JinGeSiActivity.this, DaBaiTaActivity.class));
                break;
            case R.id.DBT_content:
                Jianjie_dadian_actiivty.actionstart1(JinGeSiActivity.this,name,"大白塔");
                break;
            case R.id.DCBD_yinglian_detail:
                YinglianShowActivity  .actionstart(JinGeSiActivity.this,name,"大慈延寿宝殿");
                break;
            case R.id.DCBD_voice_desc:
                startActivity(new Intent(JinGeSiActivity.this, DaCiYanShouBaoDianActivity.class));
                break;
            case R.id.DCBD_content:
                Jianjie_dadian_actiivty.actionstart1(JinGeSiActivity.this,name,"大慈延寿宝殿");
                break;
            ...
            case R.id.TWD_content:
                Jianjie_dadian_actiivty.actionstart1(JinGeSiActivity.this,name,"天王殿");
                break;
            default:
                break;
        }
