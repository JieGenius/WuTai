...
public class LQSGuanYinDianActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lqs_guan_yin_dian);
        initView();
    }
    ...
    public void initView(){
        ...
        //设置声音
        SpeechUtility.createUtility(LQSGuanYinDianActivity.this, SpeechConstant.APPID +"=5b63c383");  //=后面这里要替换成自己申请的 AppID
        ...
        collapsingToolbarLayout.setTitle("龙泉寺观音殿");
        ...
        String content = mContex.getString(R.string.long_quan_si_da_guan_yin_dian_text);
        voiceContent.setText(content);
        AudioUtils.getInstance().init(LQSGuanYinDianActivity.this); //初始化语音对象
        //从string里面获取文本
