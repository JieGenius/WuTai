package com.example.wutai.wutaimoutain.PuSaDingVoice;
...
public class DaXiongBaoDianActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pu_sa_ding_da_xiong_bao_dian);
        initView();
    }
    ...
    public void initView(){
        ...
        showImgView = (ImageView) findViewById(R.id.pu_sa_ding_da_xiong_bao_dian_img);
        ...
        String content = mContex.getString(R.string.pu_sa_ding_da_xiong_bao_dian_text);
