...
public class JGSTianWangDianActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jgs_tian_wang_dian);
        initView();
    }
    ...
    public void initView(){
        ...
        //设置声音
        SpeechUtility.createUtility(JGSTianWangDianActivity.this, SpeechConstant.APPID +"=5b63c383");  //=后面这里要替换成自己申请的 AppID
        mContex = getApplicationContext();
        Toolbar toolbar = (Toolbar)findViewById(R.id.toolbar);
        collapsingToolbarLayout =  (CollapsingToolbarLayout)findViewById(R.id.collapsing_toolbar);
        showImgView = (ImageView) findViewById(R.id.jgs_tian_wang_dian_img);
        ...
        collapsingToolbarLayout.setTitle("金阁寺天王殿");
        ...
        String content = mContex.getString(R.string.jin_ge_si_tian_wang_dian_text);
        voiceContent.setText(content);
        AudioUtils.getInstance().init(JGSTianWangDianActivity.this); //初始化语音对象
        //从string里面获取文本
