...
public class YuanZhaoSiActivity extends AppCompatActivity implements View.OnClickListener,PopupMenu.OnMenuItemClickListener{
    private Button DCJG,DBT,DCYSBD,TWD;
    private String content;
    private Context mContex;
    private String name = "圆照寺";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_yuan_zhao_si);
        initView();
    ...
    public void initView(){
        //初始化声音设置
        SpeechUtility.createUtility(YuanZhaoSiActivity.this, SpeechConstant.APPID +"=5b63c383");  //=后面这里要替换成自己申请的 AppID
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.da_cang_jing_ge:
                ...
                //绑定菜单项的点击事件
                popup.setOnMenuItemClickListener(YuanZhaoSiActivity.this);
                //显示(这一行代码不要忘记了)
                popup.show();
                break;
            case R.id.da_bai_ta:
                ...
                popup2.setOnMenuItemClickListener(YuanZhaoSiActivity.this);
                popup2.show();
                break;
            case R.id.da_ci_bao_dian:
                ...
                popup3.setOnMenuItemClickListener(YuanZhaoSiActivity.this);
                popup3.show();
                break;
            case R.id.tian_wang_dian:
                ...
                popup4.setOnMenuItemClickListener(YuanZhaoSiActivity.this);
                popup4.show();
                break;
            default:
                break;
    ...
    public boolean onMenuItemClick(MenuItem item) {
        switch (item.getItemId()){
            case R.id.DCJG_yinglian_detail:
                YinglianShowActivity.actionstart(YuanZhaoSiActivity.this,name,"大藏经阁");
                break;
            case R.id.DCJG_voice_desc:
                startActivity(new Intent(YuanZhaoSiActivity.this, DaCangJingGeActivity.class));
                break;
            case R.id.DCJG_content:
                Jianjie_dadian_actiivty.actionstart1(YuanZhaoSiActivity.this,name,"藏经阁");
                break;
            case R.id.DBT_yinglian_detail:
                YinglianShowActivity  .actionstart(YuanZhaoSiActivity.this,name,"大白塔");
                break;
            case R.id.DBT_voice_desc:
                startActivity(new Intent(YuanZhaoSiActivity.this, DaBaiTaActivity.class));
                break;
            ...
            case R.id.DCBD_content:
                Jianjie_dadian_actiivty.actionstart1(YuanZhaoSiActivity.this,name,"大慈延寿宝殿");
                break;
            case R.id.TWD_yinglian_detail:
                YinglianShowActivity  .actionstart(YuanZhaoSiActivity.this,name,"天王殿");
                break;
            case R.id.TWD_voice_desc:
                startActivity(new Intent(YuanZhaoSiActivity.this, TianWangDianActivity.class));
                break;
            case R.id.TWD_content:
                Jianjie_dadian_actiivty.actionstart1(YuanZhaoSiActivity.this,name,"天王殿");
                break;
            default:
                break;
        }
