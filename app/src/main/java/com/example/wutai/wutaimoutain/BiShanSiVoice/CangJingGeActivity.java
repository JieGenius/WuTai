...
public class CangJingGeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bi_shan_si_cang_jing_ge);
        initView();
    }

    public void initView(){
        //设置声音
        SpeechUtility.createUtility(CangJingGeActivity.this, SpeechConstant.APPID +"=5b63c383");  //=后面这里要替换成自己申请的 AppID
        mContex = getApplicationContext();
        Toolbar toolbar = (Toolbar)findViewById(R.id.toolbar);
        collapsingToolbarLayout =  (CollapsingToolbarLayout)findViewById(R.id.collapsing_toolbar);
        showImgView = (ImageView) findViewById(R.id.bi_shan_si_cang_jing_ge_img);
        ...
        collapsingToolbarLayout.setTitle("藏经阁");
        ...
        Glide.with(mContex).load(R.mipmap.bi_shan_si_cang_jing_ge_voice).into(showImgView);
        String content = mContex.getString(R.string.bi_shan_si_cang_jing_ge_text);
        voiceContent.setText(content);
        AudioUtils.getInstance().init(CangJingGeActivity.this); //初始化语音对象
        //从string里面获取文本
