package com.example.wutai.wutaimoutain.BiShanSiVoice;
...
public class TianWangDianActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bi_shan_si_tian_wang_dian);
        initView();
    }
    ...
    public void initView(){
        ...
        showImgView = (ImageView) findViewById(R.id.tian_wang_dian_img);
        ...
        String content = mContex.getString(R.string.bi_shan_si_tian_wang_dian_text);
