...
public class SengSheActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pu_sa_ding_seng_she);
        initView();
    }

    public void initView(){
        //设置声音
        SpeechUtility.createUtility(SengSheActivity.this, SpeechConstant.APPID +"=5b63c383");  //=后面这里要替换成自己申请的 AppID
        mContex = getApplicationContext();
        Toolbar toolbar = (Toolbar)findViewById(R.id.toolbar);
        collapsingToolbarLayout =  (CollapsingToolbarLayout)findViewById(R.id.collapsing_toolbar);
        showImgView = (ImageView) findViewById(R.id.pu_sa_ding_seng_she_img);
        ...
        collapsingToolbarLayout.setTitle("僧舍");
        ...
        String content = mContex.getString(R.string.pu_sa_ding_seng_she_text);
        voiceContent.setText(content);
        AudioUtils.getInstance().init(SengSheActivity.this); //初始化语音对象
        //从string里面获取文本
