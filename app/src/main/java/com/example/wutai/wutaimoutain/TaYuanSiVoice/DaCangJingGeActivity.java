...
public class DaCangJingGeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_da_cang_jing_ge);
        initView();
        isPause = false;
    }
    public void initView(){
        ...
        //设置声音
        SpeechUtility.createUtility(DaCangJingGeActivity.this, SpeechConstant.APPID +"=5b63c383");  //=后面这里要替换成自己申请的 AppID
        mContex = getApplicationContext();
        Toolbar toolbar = (Toolbar)findViewById(R.id.toolbar);
        collapsingToolbarLayout =  (CollapsingToolbarLayout)findViewById(R.id.collapsing_toolbar);
        showImgView = (ImageView)findViewById(R.id.da_cang_jing_ge_img);
        ...
        Glide.with(mContex).load(R.mipmap.da_cang_jing_ge_voice).into(showImgView);
        String content = mContex.getString(R.string.da_cang_jing_ge_text);
        voiceContent.setText(content);
        AudioUtils.getInstance().init(DaCangJingGeActivity.this); //初始化语音对象
        //从string里面获取文本
