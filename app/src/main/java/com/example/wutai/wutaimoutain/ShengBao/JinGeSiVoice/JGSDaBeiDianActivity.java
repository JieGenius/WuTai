...
public class JGSDaBeiDianActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jgs_da_bei_dian);
        initView();
    }
    ...
    public void initView(){
        ...
        //设置声音
        SpeechUtility.createUtility(JGSDaBeiDianActivity.this, SpeechConstant.APPID +"=5b63c383");  //=后面这里要替换成自己申请的 AppID
        mContex = getApplicationContext();
        Toolbar toolbar = (Toolbar)findViewById(R.id.toolbar);
        collapsingToolbarLayout =  (CollapsingToolbarLayout)findViewById(R.id.collapsing_toolbar);
        showImgView = (ImageView) findViewById(R.id.da_bei_dian_img);
        ...
        collapsingToolbarLayout.setTitle("金阁寺大悲殿");
        ...
        Glide.with(mContex).load(R.mipmap.jin_ge_si_da_bei_dian_voice_img).into(showImgView);
        String content = mContex.getString(R.string.jin_ge_si_da_bei_dian_text);
        voiceContent.setText(content);
        AudioUtils.getInstance().init(JGSDaBeiDianActivity.this); //初始化语音对象
        //从string里面获取文本
