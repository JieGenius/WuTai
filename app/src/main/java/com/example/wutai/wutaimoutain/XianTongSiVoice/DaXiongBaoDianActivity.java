...
public class DaXiongBaoDianActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_da_xiong_bao_dian);
        initView();
    }
    ...
    public void initView(){
        ...
        showImgView = (ImageView) findViewById(R.id.da_xiong_bao_dian_img);
        ...
        String content = mContex.getString(R.string.da_xiong_bao_dian_text);
