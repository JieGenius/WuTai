...
public class TianWangDianActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_luo_hou_si_tian_wang_dian);
        initView();
    }

    public void initView(){
        //设置声音
        SpeechUtility.createUtility(TianWangDianActivity.this, SpeechConstant.APPID +"=5b63c383");  //=后面这里要替换成自己申请的 AppID
        mContex = getApplicationContext();
        Toolbar toolbar = (Toolbar)findViewById(R.id.toolbar);
        collapsingToolbarLayout =  (CollapsingToolbarLayout)findViewById(R.id.collapsing_toolbar);
        showImgView = (ImageView) findViewById(R.id.luo_hou_si_tian_wang_dian_img);
        ...
        collapsingToolbarLayout.setTitle("天王殿");
        ...
        Glide.with(mContex).load(R.mipmap.bi_shan_si_tian_wang_dian_voice).into(showImgView);
        String content = mContex.getString(R.string.luo_hou_si_tian_wang_dian_text);
        voiceContent.setText(content);
        AudioUtils.getInstance().init(TianWangDianActivity.this); //初始化语音对象
        //从string里面获取文本
