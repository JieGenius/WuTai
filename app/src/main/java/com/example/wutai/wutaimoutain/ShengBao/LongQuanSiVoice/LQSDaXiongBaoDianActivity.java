...
public class LQSDaXiongBaoDianActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lqs_da_xiong_bao_dian);
        initView();
    }
    ...
    public void initView(){
        ...
        //设置声音
        SpeechUtility.createUtility(LQSDaXiongBaoDianActivity.this, SpeechConstant.APPID +"=5b63c383");  //=后面这里要替换成自己申请的 AppID
        ...
        collapsingToolbarLayout.setTitle("龙泉寺大雄宝殿");
        ...
        Glide.with(mContex).load(R.mipmap.long_quan_si_da_xiong_bao_dian_voice_img).into(showImgView);
        String content = mContex.getString(R.string.long_quan_si_da_xiong_bao_dian_text);
        voiceContent.setText(content);
        AudioUtils.getInstance().init(LQSDaXiongBaoDianActivity.this); //初始化语音对象
        //从string里面获取文本
