...
public class SXSDaWenShuDianActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sxsda_wen_shu_dian);
        initView();
    }
    ...
    public void initView(){
        ...
        //设置声音
        SpeechUtility.createUtility(SXSDaWenShuDianActivity.this, SpeechConstant.APPID +"=5b63c383");  //=后面这里要替换成自己申请的 AppID
        mContex = getApplicationContext();
        Toolbar toolbar = (Toolbar)findViewById(R.id.toolbar);
        collapsingToolbarLayout =  (CollapsingToolbarLayout)findViewById(R.id.collapsing_toolbar);
        showImgView = (ImageView) findViewById(R.id.shu_xiang_si_img);
        ...
        collapsingToolbarLayout.setTitle("殊像寺文殊殿");
        ...
        String content = mContex.getString(R.string.shu_xiang_si_da_wen_shu_dian_text);
        voiceContent.setText(content);
        AudioUtils.getInstance().init(SXSDaWenShuDianActivity.this); //初始化语音对象
        //从string里面获取文本
