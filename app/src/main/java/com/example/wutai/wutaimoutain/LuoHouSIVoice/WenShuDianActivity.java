...
public class WenShuDianActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_luo_hou_si_wen_shu_dian);
        initView();
    }

    public void initView(){
        //设置声音
        SpeechUtility.createUtility(WenShuDianActivity.this, SpeechConstant.APPID +"=5b63c383");  //=后面这里要替换成自己申请的 AppID
        mContex = getApplicationContext();
        Toolbar toolbar = (Toolbar)findViewById(R.id.toolbar);
        collapsingToolbarLayout =  (CollapsingToolbarLayout)findViewById(R.id.collapsing_toolbar);
        showImgView = (ImageView) findViewById(R.id.luo_hou_si_wen_shu_dian_img);
        ...
        Glide.with(mContex).load(R.mipmap.luo_hou_si_wen_shu_dian_voice).into(showImgView);
        String content = mContex.getString(R.string.luo_hou_si_wen_shu_dian_text);
        voiceContent.setText(content);
        AudioUtils.getInstance().init(WenShuDianActivity.this); //初始化语音对象
        //从string里面获取文本
