...
public class SXSJiaLanDianActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sxsjia_lan_dian);
        initView();
    }
    ...
    public void initView(){
        ...
        //设置声音
        SpeechUtility.createUtility(SXSJiaLanDianActivity.this, SpeechConstant.APPID +"=5b63c383");  //=后面这里要替换成自己申请的 AppID
        ...
        collapsingToolbarLayout.setTitle("殊像寺珈蓝殿");
        ...
        String content = mContex.getString(R.string.shu_xiang_si_jia_lan_dian_text);
        voiceContent.setText(content);
        AudioUtils.getInstance().init(SXSJiaLanDianActivity.this); //初始化语音对象
        //从string里面获取文本
